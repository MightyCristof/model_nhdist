...
if keyword_set(rxz005) then begin
    ...
    if keyword_set(grid) then begin
        ...
        save,rx_grid,col_nh,row_z,file='rxz_grid005.sav'
    endif
endif


if keyword_set(rxz01) then begin
    if keyword_set(xcm) then begin
        zra = [0.:0.8:0.01]

        openw,1,'run_model_scat01_rxz.xcm' 
        printf,1,'abund angr'
        printf,1,'cosmo 70 0 0.73'
        printf,1,'method leven 10 0.01'
        printf,1,'xsect vern'
        printf,1,'xset delta 0.01'
        printf,1,'set id [open fx210_scat01_rxz.dat a]'
        for i = 0,n_elements(zra)-1 do begin
            printf,1,'model  constant*phabs*zphabs(atable{/Users/ccarroll/heasoft-6.25/localmodels/borus/borus02_v170323a.fits} + zphabs*cabs*cutoffpl + constant*cutoffpl)'
            printf,1,'              1         -1          0          0      1e+10      1e+10'
            printf,1,'           0.01         -1          0          0     100000      1e+06'
            ...
            printf,1,'= p6'
            printf,1,'= p12'
            printf,1,'           0.01       0.01          0          0      1e+10      1e+10'
            printf,1,'= p5'
            printf,1,'= p6'
            printf,1,'= p12'
            printf,1,'new 4 '+string(zra[i],format='(f0.2)')
    ...
    if keyword_set(grid) then begin
        readcol,'fx210_scat01_rxz.dat',col,dcol,format='d,d'
        ibreak = where(dcol lt 0.,zlen)
        rx_grid = dblarr(width(ibreak)-1,zlen)
        row_z = col[ibreak]
        num_nh = width(ibreak)-1
        ...
        ibreak = [ibreak,ibreak[-1]+width(ibreak)]
        for i = 0,zlen-1 do begin
            readcol,'fx210_scat01_rxz.dat',fx,format='d',skipline=ibreak[i]+1,numline=num_nh,/silent
            rx_grid[*,i] = alog10(fx/fx[0])
        endfor
        save,rx_grid,col_nh,row_z,file='rxz_grid01.sav'
    endif
endif
...
if keyword_set(scat005) then begin
    ...
    if keyword_set(grid) then begin
        readcol,'fx210_scat01.dat',col,dcol,format='d,d'
        rx_scat = alog10(col[1:-1]/col[1])
        save,rx_scat,file='rx_scat01.sav'
    endif
endif



if keyword_set(scat01) then begin
    if keyword_set(xcm) then begin
        openw,1,'run_model_scat01.xcm' 
        printf,1,'abund angr'
        printf,1,'cosmo 70 0 0.73'
        printf,1,'method leven 10 0.01'
        printf,1,'xsect vern'
        printf,1,'xset delta 0.01'
        printf,1,'set id [open fx210_scat01.dat a]'
        printf,1,'model  constant*phabs*zphabs(atable{/Users/ccarroll/heasoft-6.25/localmodels/borus/borus02_v170323a.fits} + zphabs*cabs*cutoffpl + constant*cutoffpl)'
        printf,1,'              1         -1          0          0      1e+10      1e+10'
        printf,1,'           0.01         -1          0          0     100000      1e+06'
        printf,1,'           0.01         -1          0          0     100000      1e+06'
